/*
  ...
  - You are about to drop the column `roll` on the `userEntity` table. All the data in the column will be lost.
  - Added the required column `rol` to the `userEntity` table without a default value. This is not possible if the table is not empty.
